<?php
    ...
    //Get Property data
    $stmt = $pdo->query("SELECT properties.id, properties.title, properties.description, properties.category, properties.price, properties.address, properties.country, properties.state, properties.city, properties.created_at FROM properties ORDER BY id DESC");
                        ...
                        <td>
                            <div class="d-lg-flex align-items-center position-relative">
                                ...
                                <div class="ps-lg-4 md-pt-10">
                                    <a href="#" class="property-name tran3s color-dark fw-500 fs-20 stretched-link">
