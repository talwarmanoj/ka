			...
			<div class="position-relative">
				...
				<nav class="dasboard-main-nav pt-30 pb-30 bottom-line">
					<ul class="style-none">
						...
						<li class="plr">
							<a href="countries.php" class="d-flex w-100 align-items-center <?php echo isactive('/countries'); ?>">
								<img src="images/icon/icon_6.svg" alt="">
								<span>Country</span>
							</a>
						</li>
						...
						<li class="plr">
							<a href="states.php" class="d-flex w-100 align-items-center <?php echo isactive('/states'); ?>">
								<img src="images/icon/icon_6.svg" alt="">
								<span>State</span>
							</a>
						</li>
